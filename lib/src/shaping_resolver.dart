...
/// unlike [_charForms], this maps isolated forms to basic forms.
/// e.g The letter 'ل' is mapped to (0x644) instead of the isolated form (0xFE8E).
final Map<int, int> _charFormsWithBasicForms = {
  0x30671: 0xFB50,
  0x20671: 0xFB51,
  0x3067B: 0xFB52,
  0x2067B: 0xFB53,
...
int _getCharacterByLetterForm(int ch, _LetterForm form, Map<int, int> charForms) {
